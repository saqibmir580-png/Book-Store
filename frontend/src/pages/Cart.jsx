...
function Cart() {
  ...
  return (
    <div className="bg-zinc-900 px-12 h-screen py-8">
      ...
      {Cart && Cart.length > 0 && (
        <>
          <h1 className="text-5xl font-semibold text-zinc-400 mb-0">
            Your Cart
          </h1>
          {Cart.map((items, i) => (
            <div
            ...
            >
              ...
              <div className="flex mt-4 w-full md:w-auto items-center justify-between">
                <h1 className="text-zinc-100 text-3xl font-semibold flex">
                  ₹{items.price}
                </h1>
                <button
        ...
        <div className="mt-4 w-full flex items-center justify-end">
          <div className="p-4 bg-zinc-800 rounded">
            ...
            <div className="w-[100%] mt-3">
              <button
                className="bg-zinc-100 rounded px-4 py-2 flex justify-center w-full font-semibold hover:bg-blue-100"
                onClick={PlaceOrder}
              >
                Place Your Order
              </button>
